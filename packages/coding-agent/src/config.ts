...
// Identifies a build produced from this fork. Internal only: it routes update checks
// (see utils/version-check.ts) and must never be appended to the displayed version,
// which is the exact published package version.
