...
describe("AgentSession auto-compaction queue resume", () => {
	...
	it("should not compact repeatedly after overflow recovery already attempted", async () => {
		...
		// Fork: _runAutoCompaction returns a boolean that gates retry, and this fork keeps
		// failed overflow recovery retryable. Resolve true so this asserts the
		// "already recovered successfully" case rather than a failed-recovery retry.
